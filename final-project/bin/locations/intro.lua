...
-- Filename: 		intro.lua
-- Created: 		05-06-15
-- Description: 	Introduction of game
-- ------------------------------------------------
...
print(" |  the Ariareach, your homeland, to eradicate the evil beast at work within.  However, now is not    |")
print(" |  the time to attack---you and your party are exauhsted, and your equipment is ruined after many    |")
...
print(" |  new equipment is a must to be able to handle the abomination within, so doing some hunting or     |")
